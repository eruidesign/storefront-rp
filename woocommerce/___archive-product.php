...
if($term->parent > 0){
    ...
    //echo 'Parent Slug: '.$parent_term_slug.'<br>';
...
if(isset($parent_term_slug) && $parent_term_slug == 'wam'){?>

    <?php //echo 'Wam is your Parent and you are: '.$term->slug;
